 ...
 */
export function getEditorBaseStyles(): string {
    return `
        :root {
 ...
 */
export function getRecordingPanelStyles(): string {
    return `
        /* ========== Record Button ========== */
        .record-btn {
            display: flex;
 ...
 */
export function getTimingControlStyles(): string {
    return `
        /* ========== Timing Slider ========== */
        .timing-control {
            display: flex;
 ...
 */
export function renderKeyAssignmentPanel(
    panelId: string,
    title: string,
    subtitle: string,
    showAutoAssign = true
 ...
 */
export function renderTimingSlider(defaultOffset = -50): string {
    return `
 ...
 */
export function renderRecordButton(): string {
    return `
 ...
 */
export function renderHelpTip(id: string, icon: string, message: string): string {
    return `
 ...
 */
export function getTransportUtilsScript(): string {
    return `
    // Transport state
    let transportState = {
        current_beat: 0,
 ...
 */
export function getNumpadUtilsScript(): string {
    return `
 ...
 */
export function getRecordButtonScript(): string {
    return `
 ...
 */
export function getCollapsiblePanelScript(): string {
    return `
