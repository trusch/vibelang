...
export class SampleBrowser {
    ...
    private constructor(panel: vscode.WebviewPanel, store: StateStore, extensionPath: string) {
        this._panel = panel;
        this._store = store;
    ...
    public static createOrShow(store: StateStore, extensionPath: string) {
    ...
    public static revive(panel: vscode.WebviewPanel, store: StateStore, extensionPath: string) {
        SampleBrowser.currentPanel = new SampleBrowser(panel, store, extensionPath);
    }
