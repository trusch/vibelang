...
class MelodyEditor {
    ...
    loadMelody(melodyName) {
        ...
        const grid = melodyString
            ? (0, melodyParser_1.parseMelodyString)(melodyString)
        ...
        switch (message.command) {
            ...
            case 'updateGrid':
                if (this._currentMelody) {
                    ...
                    const stepsPerBar = message.stepsPerBar || 4;
                    const newMelodyString = (0, melodyParser_1.generateMelodyString)(this._currentMelody.grid, stepsPerBar);
            ...
            case 'previewNote':
                ...
                if (this._currentMelody?.voiceName) {
                    ...
                    const duration = message.duration || 0.25; // Duration in seconds
                    try {
    ...
    async _updateCodeWithMelody(newMelodyString) {
        ...
        try {
            ...
            if (match) {
                ...
                edit.replace(document.uri, new vscode.Range(lineIndex, start, lineIndex, end), `.notes("${newMelodyString}")`);
