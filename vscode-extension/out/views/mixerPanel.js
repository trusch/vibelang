...
class MixerViewProvider {
    constructor(store) {
        ...
        this._disposables.push(store.onGroupsUpdate(() => {
            if (this._isInitialized) {
                this._updateContent();
            }
        }));
        this._disposables.push(store.onStatusChange(() => {
            if (this._isInitialized) {
                this._updateContent();
...
<body>
    ...
    async _handleMessage(message) {
        switch (message.command) {
            case 'setAmp':
                await this._store.runtime.setGroupParam(message.path, 'amp', message.value);
                break;
            case 'setPan':
                await this._store.runtime.setGroupParam(message.path, 'pan', message.value);
                break;
            case 'mute':
...
exports.MixerViewProvider = MixerViewProvider;
MixerViewProvider.viewType = 'vibelang.mixerView';
//# sourceMappingURL=mixerPanel.js.map