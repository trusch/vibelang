...
exports.getWaveformData = getWaveformData;
const fs = require("fs");
const path = require("path");
/**
 * Get waveform data from an audio file
 */
async function getWaveformData(filePath, options = {}) {
 ...
 */
async function parseWavFile(filePath, targetPoints, channel) {
 ...
 */
function extractPcmSamples(buffer, header) {
 ...
 */
function downsampleToPeaks(samples, targetPoints, numChannels, channel) {
...
//# sourceMappingURL=waveformProvider.js.map