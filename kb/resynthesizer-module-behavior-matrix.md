...
|---|---|---|
| 1 | Keep `morphagene`, `spectraphon`, `maths`, and `wogglebug` aligned with this matrix. | They are the core "resynthesis plus modulation" behavior and already have stdlib footholds. |
