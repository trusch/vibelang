...
const EMBEDDED_MANIFESTS: &[(&str, &str)] = &[
    (
        "oscillators",
        include_str!("ugen_manifests/oscillators.json"),
    ),
    ("filters", include_str!("ugen_manifests/filters.json")),
    ("envelopes", include_str!("ugen_manifests/envelopes.json")),
    ("delays", include_str!("ugen_manifests/delays.json")),
    ("reverb", include_str!("ugen_manifests/reverb.json")),
    ("noise", include_str!("ugen_manifests/noise.json")),
    ("dynamics", include_str!("ugen_manifests/dynamics.json")),
    ("panning", include_str!("ugen_manifests/panning.json")),
    ("buffers", include_str!("ugen_manifests/buffers.json")),
    ("bufdelays", include_str!("ugen_manifests/bufdelays.json")),
    ("triggers", include_str!("ugen_manifests/triggers.json")),
    ("math", include_str!("ugen_manifests/math.json")),
    ("control", include_str!("ugen_manifests/control.json")),
    ("inout", include_str!("ugen_manifests/inout.json")),
    (
        "multichannel",
    ...
    ("info", include_str!("ugen_manifests/info.json")),
    ("physical", include_str!("ugen_manifests/physical.json")),
    ("pitchtime", include_str!("ugen_manifests/pitchtime.json")),
    ("random", include_str!("ugen_manifests/random.json")),
];
