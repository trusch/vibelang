...
pub use api::{
    clear_effect_registry, clear_modulator_registry, clear_synthdef_registry, effect_exists,
    get_all_effects_encoded, get_all_modulators_encoded, get_all_synthdefs_encoded,
    get_effect_param_defaults, get_modulator_param_defaults, get_synthdef_param_defaults,
    modulator_synthdef_exists, register_synthdef_api, register_synthdef_ir, set_deploy_callback,
