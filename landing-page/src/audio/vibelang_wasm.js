...
const VibelangEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vibelangengine_free(ptr >>> 0, 1));
/**
...
export class VibelangEngine {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        VibelangEngineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_vibelangengine_free(ptr, 0);
    }
    /**
     * Create a new VibeLang engine.
     */
    constructor() {
        const ret = wasm.vibelangengine_new();
        this.__wbg_ptr = ret >>> 0;
        VibelangEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    execute(script) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vibelangengine_execute(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     */
    getPlaybackData() {
        const ret = wasm.vibelangengine_getPlaybackData(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    getSynthdefs() {
        const ret = wasm.vibelangengine_getSynthdefs(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     * @returns {any}
     */
    static getSystemSynthdefs() {
        const ret = wasm.vibelangengine_getSystemSynthdefs();
        return ret;
    }
    /**
     ...
     */
    clearSynthdefs() {
        wasm.vibelangengine_clearSynthdefs(this.__wbg_ptr);
    }
    /**
    ...
    static parseNote(note) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.vibelangengine_parseNote(ptr0, len0);
        return ret;
    }
    /**
     ...
     */
    static dbToAmp(db) {
        const ret = wasm.vibelangengine_dbToAmp(db);
        return ret;
    }
    /**
     ...
     */
    static ampToDb(amp) {
        const ret = wasm.vibelangengine_ampToDb(amp);
        return ret;
    }
}
if (Symbol.dispose) VibelangEngine.prototype[Symbol.dispose] = VibelangEngine.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vibelang_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
